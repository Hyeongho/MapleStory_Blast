...
private:
	std::unordered_map<std::string, std::shared_ptr<CMesh>> m_mapMesh;
	std::unordered_map<std::string, std::shared_ptr<CShader>> m_mapShader;
	std::unordered_map<std::string, std::shared_ptr<CTexture>> m_mapTexture;
	std::unordered_map<std::string, std::shared_ptr<CMaterial>> m_mapMaterial;
	std::unordered_map<std::string, std::shared_ptr<CAnimationSequence>> m_mapAnimationSequence2D;
	std::unordered_map<std::string, std::shared_ptr<CSound>> m_mapSound;
