...
{
	m_Anim2DBuffer = new CAnimationConstantBuffer;
...
{
	CAnimationSequence* Sequence = FindAnimationSequence2D(Name);
...
CAnimationSequence* CAnimationManager::FindAnimationSequence2D(const std::string& Name)
{
