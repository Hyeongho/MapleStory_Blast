...
CMaterial::CMaterial() : m_BaseColor(Vector4::White), m_AmbientColor(0.2f, 0.2f, 0.2f, 1.f), m_SpecularColor(Vector4::White), m_EmissiveColor(Vector4::Black), m_Opacity(1.f)
{
	SetTypeID<CMaterial>();
