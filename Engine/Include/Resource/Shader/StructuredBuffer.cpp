...
CStructuredBuffer::CStructuredBuffer() : m_Desc{}, m_Buffer(nullptr), m_SRV(nullptr), m_UAV(nullptr), m_Size(0), m_Count(0), m_StructuredBufferShaderType(0), m_Register(0), m_Dynamic(false)
{
}
