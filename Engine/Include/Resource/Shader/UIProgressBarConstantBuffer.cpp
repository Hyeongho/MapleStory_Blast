...
CUIProgressBarConstantBuffer::CUIProgressBarConstantBuffer() : m_BufferData{}
{
}

CUIProgressBarConstantBuffer::CUIProgressBarConstantBuffer(const CUIProgressBarConstantBuffer& Buffer) : CConstantBufferData(Buffer)
{
