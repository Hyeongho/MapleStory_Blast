...
CGraphicShader::CGraphicShader() : m_VS(nullptr), m_VSBlob(nullptr), m_PS(nullptr), m_PSBlob(nullptr), m_HS(nullptr), m_HSBlob(nullptr), m_DS(nullptr), m_DSBlob(nullptr), m_GS(nullptr), m_GSBlob(nullptr), m_InputSize(0), m_InputLayout(nullptr)
{
}
...
void CGraphicShader::AddInputDesc(const char* SemanticName, unsigned int SemanticIndex, DXGI_FORMAT Fmt, unsigned int Slot, unsigned int Size, D3D11_INPUT_CLASSIFICATION SlotClass, unsigned int InstanceDataStepRate)
{
