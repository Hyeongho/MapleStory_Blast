...
CRenderTarget::CRenderTarget() : m_TargetView(nullptr), m_TargetTex(nullptr), m_DepthView(nullptr), m_PrevTargetView(nullptr), m_PrevDepthView(nullptr), m_Surface(nullptr), m_ClearColor{}, m_DebugRender(true), m_CBuffer(nullptr)
{
...
bool CRenderTarget::CreateTarget(const std::string& Name, unsigned int Width, unsigned int Height, DXGI_FORMAT PixelFormat, DXGI_FORMAT DepthFormat)
{
	SetName(Name);
