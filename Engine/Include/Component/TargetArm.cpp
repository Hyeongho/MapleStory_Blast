...
CTargetArm::CTargetArm() : m_TargetDistance(300.f), m_TargetDistanceAxis(AXIS::AXIS_Z)
{
...
CTargetArm::CTargetArm(const CTargetArm& component) : CSceneComponent(component)
{
