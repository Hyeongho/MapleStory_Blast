...
CColliderPixel::CColliderPixel() : m_Info(nullptr)
{
...
CColliderPixel::CColliderPixel(const CColliderPixel& component) : CCollider2D(component)
{
...
void CColliderPixel::SetInfoFullPath(const std::string& Name, const TCHAR* FullPath)
{
	...
	for (int i = PathLength - 1; i >= 0; i--)
	{
		...
		{
			if ((FullPath[i - 1] == 'n' || FullPath[i - 1] == 'N') && (FullPath[i - 2] == 'i' || FullPath[i - 2] == 'I') && (FullPath[i - 3] == 'b' || FullPath[i - 3] == 'B') && (FullPath[i - 4] == '\\' || FullPath[i - 4] == '/'))
			{
