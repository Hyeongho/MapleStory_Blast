...
protected:
    ...
    std::shared_ptr<class CMesh> m_TileMesh;
    std::shared_ptr<class CMaterial> m_TileMaterial;
    std::shared_ptr<class CTexture> m_TileBackTexture;
    ETileShape m_Shape;
    int m_CountX;
    int m_CountY;
    int m_Count;
