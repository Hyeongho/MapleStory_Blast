...
CUIText::CUIText() : m_Layout(nullptr), m_Brush(nullptr), m_RenderTarget(nullptr), m_FontSize(10.f), m_Transparency(false), m_Opacity(1.f), m_Color(Vector4::White), m_ShadowEnable(false), m_ShadowBrush(nullptr), m_ShadowTransparency(false), m_ShadowOpacity(1.f), m_AlignH(Text_Align_H::Left), m_AlignV(Text_Align_V::Top), m_ShadowOffset(1.f, 1.f)
{
    m_Color.w = m_Opacity;
